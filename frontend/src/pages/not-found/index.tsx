    ...
    <div className="flex min-h-screen flex-col bg-[#F8FAFC]">
      ...
      <div className="flex grow items-center px-6 xl:px-10">
        <div className="mx-auto text-center">
          <img src={NotFoundImg} alt="not found" className="mx-auto mb-8 aspect-[360/326] max-w-[256px] xs:max-w-[370px] lg:mb-12 2xl:mb-16" />
          ...
          <Link to={"/"}>
            <Button size="xl" color="primary" className="mt-8 h-12 px-4 xl:h-14 xl:px-6">
